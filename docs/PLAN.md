...
- Solver payloads now expose public chance branch nodes for flop-to-turn and turn-to-river low/mid/high buckets. These nodes derive branch-specific compact strategy/metric tables while the full continuation tree remains pending.
