...
- Last verified: `bash scripts/verify.sh` exited 0 after rendering Solver Studio bet-response terminal child nodes as pure branch rows. Latest bench: `cargo bench -p gto_lab_engine --bench engine_bench` exited 0 with `nlh7_eval` ~11.66 ns/eval.
