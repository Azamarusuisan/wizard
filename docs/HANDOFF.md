...
- Last verified: `bash scripts/verify.sh` exited 0 after weighting merged compact flop river equities by river branch mass. Latest bench: `cargo bench -p gto_lab_engine --bench engine_bench` exited 0 with `nlh7_eval` ~11.66 ns/eval.
