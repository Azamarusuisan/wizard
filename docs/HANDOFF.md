...
- Last verified: `bash scripts/verify.sh` exited 0 after rejecting invalid 1-card/2-card solver boards. Latest bench: `cargo bench -p gto_lab_engine --bench engine_bench` exited 0 with `nlh7_eval` ~11.66 ns/eval.
