...
- The TypeScript fallback evaluator test also covers PLO5 exact two-hole usage.
...
- Last verified: `bash scripts/verify.sh` exited 0 after adding PLO5 exact-two-hole fallback coverage.
